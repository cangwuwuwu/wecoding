...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authenticationEntryPoint((request, response, e) -> this.exceptionReturn(
                            response, e, HttpServletResponse.SC_UNAUTHORIZED, "未登录或登录过期"))
                .and()
                    .authorizeRequests()
                ...
                .and()
                    ...
                    .failureHandler(((request, response, e) -> {
                        ...
                        this.exceptionReturn(response, e, HttpServletResponse.SC_UNAUTHORIZED, message);
                    }))
                ...
                .and()
                    ...
                    .accessDeniedHandler((request, response, e) -> this.exceptionReturn(
                                response, e, HttpServletResponse.SC_FORBIDDEN, "权限不足"))
                .and()
                    .rememberMe()
    ...
    private void exceptionReturn(
            ...
            Exception e, Integer status, String message) throws IOException {
//        e.printStackTrace();
